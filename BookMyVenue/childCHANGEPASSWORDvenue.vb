...
Public Class childCHANGEPASSWORDvenue
    ...
    Private Sub hideshow_pwd(txtbox As TextBox, btn As Button)
        ...
        End If
    End Sub
    Private Sub childCHANGEPASSWORDvenue_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        pConnectDB()
    End Sub
    ...
    Private Sub BtnCONFIRM_Click(sender As Object, e As EventArgs) Handles BtnCONFIRM.Click
        ...
        If String.Equals(TxtNEWPWD.Text, TxtRENEWPWD.Text) Then
            id = VENUEOWNERdashboard.venueid
            sql1 = "SELECT PASSWORD FROM venueDETAILS WHERE PASSWORD = '" & TxtOLDPWD.Text & "' AND VENUE_ID = " & id
            ...
            If dr.Read() = True Then
                ...
                Else
                    ...
                    sql2 = "UPDATE venueDETAILS SET [PASSWORD] = '" & TxtNEWPWD.Text & "'" & " WHERE [VENUE_ID] = " & id
